...
function replyeMessage(){
	 main.location.href="<%=basePath%>informationManage.do?type=saveReplyMessage&title="+$("#title").val()+"&receiveagent="+$("#receiveagent").val()+"&messagecontent="+$("#messagecontent").val();
}

function refresh(){
   main.location.href="<%=basePath%>informationManage.do?type=IfMessage";
}
	...
	<body>
			...
			<input type="hidden"  id="receiveagent" name="receiveagent" value="<%=request.getParameter("sendagentcode")%>"/>
				<table width="100%">
					<tr>
						<td align="right">
