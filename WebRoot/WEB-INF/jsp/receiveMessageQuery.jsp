...
function replymessages(sendagent,sendagentcode) {
	...
	var url = "informationManage.do?type=replyMessage&sendagent="+encodeURI(sendagent)+"&sendagentcode="+encodeURI(sendagentcode);
	var title = "回复消息";
	var width = 450;
	var height = 250;
...
function refresh(){
   main.location.href="<%=basePath%>informationManage.do?type=IfMessage&querymessageid="+$("#querymessageid").val();
}
