					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0" style="border: 1px solid #efefef">
						<tr>
							<td style="line-height: 28px;">
								<form name="subxyd" method="post" onsubmit="return waitRechargePage();" action="<%=basePath%>tenpay/pay.do" target="_bank">
									<input name="WIDsubject" type="hidden" value="购买信用点">
									<input name="WIDbody" type="hidden" value="购买${recharge.rechargeMoney/100.0}元信用点">
									<input name="WIDdefaultbank" type="hidden" value="${bank.bankBriefCode}">
