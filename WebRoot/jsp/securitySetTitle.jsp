...
<body>
  <div class="order_big_title_bg">
		    <ul>
			  <li><a href="./jsp/securitySet.jsp" class="over"  id="title0" onclick="setTab2('title',0,3)">支付密码设置</a></li>
			  <li><a href="./jsp/securityETOTP.jsp"  id="title1" onclick="setTab2('title',1,3)">动态令牌绑定</a></li>
			  <li><a href="./jsp/securityBindings.jsp"  id="title2" onclick="setTab2('title',2,3)">安全绑定</a></li>
			</ul>
  </div>
