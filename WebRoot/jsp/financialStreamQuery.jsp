...
function streamquery(pageno){
	var isShow = getisShowValue();
	var serial_ = "display:none";
	var shoptype_ = "display:none";
	var remark_ = "display:none";
	if(isShow.indexOf("0", 0)>-1){
		serial_ ="";
	}
	if(isShow.indexOf("1", 0)>-1){
		shoptype_ ="";
	}
	if(isShow.indexOf("2", 0)>-1){
		remark_ ="";
	}
			var url_ = "<%=basePath%>accountRecord.do?type=accountStreamQuery";
								url_ += bindStreamData();
								url_ += "&pageno=" + pageno;
									...
									$.ajax( {
												...
												var data=page.result;
													...
													for ( var i = 0; i < data.length; i++) {
														...
														tab += '<tr>';
														tab += "<td class='content_0' style="+serial_+">" + data[i].serial + "</td>";
														...
														tab += '<td class="content_1" style=" '+shoptype_+'">' + data[i].shoptype + '</td>';
														...
														if(remark==null){
															tab += '<td class="content_2" style="'+remark_+'">11</td>';
														}else{
															tab += '<td class="content_2" style="'+remark_+'">'+remark+'</td>';
														}
														tab += '</tr>';
													}
													if (tab != '') {
...
function getisShowValue(){
    var o = $(".isShow ul li a");
    var re = "";
    $.each(o,function(i,element){
    	var className = $(element).attr('class');
    	var value = $(element).attr('name');
      ...
      <div class="content_nrright">
        ...
        <div class="nyRight">
          ...
          <div class="gamenamebox">
            ...
            <div class="gamename">
	               <div class="spcxtj" id="con_subpcx_12">
	               <form action="" class="queryForm" id="queryForm">
	                <table width="928" border="0" cellspacing="0" cellpadding="0" class="cx">
						  <tr>
						    <td class="wz">交易流水号：</td>
						    <td><input name="tranTypeVal" type="text" class="input1" id="tranTypeVal" /></td>
						  </tr>
						  <tr>
						  <td class="wz">时间：</td>
						  <td id="queryDate" colspan="2"></td>
						   ...
						   <tr class="sType financeType">  
						  	<td class="wz">类别：</td>
						       <td class="time" colspan="2">
								...
								<li><a href="javascript:void(0)" name="1"  >转入记录</a></li>
								<li><a href="javascript:void(0)" name="2"  >转出记录</a></li>
								<li><a href="javascript:void(0)" name="3"  >充值</a></li>
								<li><a href="javascript:void(0)" name="4"  >消费</a></li>
								<li><a href="javascript:void(0)" name="5"  >扣点</a></li>
								<li><a href="javascript:void(0)" name="6"  >加点</a></li>
						   ...
						   <tr class="sType isShow">  
						  	<td class="wz">是否显示：</td>
						       <td class="time" colspan="2">
								<ul>
								<li><a href="javascript:void(0)"  name="0"  onclick="showTitle(0)"  >交易流水号</a></li>
								<li><a href="javascript:void(0)" name="1"  onclick="showTitle(1)">店铺类型</a></li>
								<li><a href="javascript:void(0)" name="2" onclick="showTitle(2)" >备注</a></li>
								</ul>
						     </td>
						  </tr>
						  <tr>
