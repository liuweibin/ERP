	              ...
	              <form action="" id="queryForm">
	                <table width="928" border="0" cellspacing="0" cellpadding="0" class="cx">
						  ...
						  <tr>
						    ...
						    <input name="button" type="submit" class="an_input2" id="button" value="查询" onclick="changeCreditsQuery(1)" />
						      <input name="button" type="button" class="an_input2" id="button" value="重置" onclick="reset_()" /></td>
						    </tr>
						</table>
	                <table width="928" border="0" cellspacing="0" cellpadding="0" class="cxjg">
	                  <tr>
	                    <td width="200" class="wz">转入编号</td>
	                    <td width="131" class="wz">序列号</td>
	                    <td width="133" class="wz">转出人账户</td>
	                    <td width="136" class="wz">转入点数(元)</td>
	                    <td width="116" class="wz">代理商余额(元)</td>
	                    <td width="116" class="wz">接收时间</td>
